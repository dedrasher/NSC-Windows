   ...
   public static class AppLocalize
    {
        ...
        {
            EnterANumber, DecimalToBinary, BinaryToDecimal, From, To, Ns,  History, ClearHistory, ClearSelected, Answer, ClearHistoryQuestion, ClearSelectedQuestion, Warning, Count, VeryBigNumber, Error, InputIsNotCorrect, AnswerTitle
        }
        private static string[] EnglishInterface = {"Enter a number", "Decimal to binary", "Binary to decimal", "From","to","N.s"  , "History", "Clear history"
                ,"Clear selected","Answer: " , "Do you really wanna clear history?" , "Do you really wanna clear selected?","Warning!","Count", "Very big number!" , "Error", "Input is not correct!" , "Answer"};
        private static string[] RussianInterface = {"Введите число", "Десятич. в двоич.", "Двоич. в десятич.", "С","до","С.ч" ,  "История", "Очистить историю"
                ,"Очистить выбранное", "Ответ: ", "Вы правда хотите очистить историю?", "Вы правда хотите очистить выбранное?","Внимание!" , "Подсчет", "Слишком большое число!" , "Ошибка", "Ввод некорректен!", "Ответ"};
