...
namespace NumericSystemConverterApp
{
    public partial class MainWindow : Window
    {
        ...
        {
            string OldAnswer = AnswerLabel.Text.Replace(AppLocalize.GetLocalizedString(AppLocalize.TranslateText.Answer, appLanguage), "");
     ...
     private void MoveCustomRadioButtonContent(float x)
        ...
        private void Window_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            calculateMode = (CalculateMode)Settings.Default.CalculateMode;
   ...
   MouseLeftButtonDownEvent,
    new RoutedEventHandler(DeselectListBoxItem));
        ...
        private void Window_Closing(object sender, CancelEventArgs e)
        {
            ...
            Settings.Default.CalculateMode = (int)calculateMode;
